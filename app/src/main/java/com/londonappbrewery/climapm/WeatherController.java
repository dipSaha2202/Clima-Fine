...
public class WeatherController extends AppCompatActivity {
    ...
    // Time between location updates (1000 milliseconds or 5 seconds)
    final long MIN_TIME = 5000;
    // Distance between location updates (1000m)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OnClickListener to the changeCityButton here:
    ...
    //on Activity result for newCity...
    @Override
    ...
    // letsDoSomeNetworking(RequestParams params):
